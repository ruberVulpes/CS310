...
public class RigginsDriverCMDARGS {
    private int[] array;
    private static final int SIZE = 100;
    private PriorityQueue<Integer> pq;
    private PriorityQueue<PrioritizedItem> pq2;

    public RigginsDriverCMDARGS(String[] parameters) {
...
//  Comment this block for linked list based implementations
        if (args[0].equals("UA") || args[0].equals("OA")) {
            if (!pq.isFull())
...
//////////////////////////////////////////////////////////////////////////////
    ...
    public static void main(String[] args) {
        if(args.length <= 0)
            throw new RuntimeException("CMD ARGS");
        new RigginsDriverCMDARGS(args);
    }
}