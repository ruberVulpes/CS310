...
public class RedBlackTree<K extends Comparable<K>, V> implements DictionaryADT<K, V> {
    ...
    public boolean add(K key, V value) {
        ...
        //Put would overwrite the old value with the key
    ...
    public K getKey(V value) {
        for (Map.Entry<K, V> me : treeMap.entrySet())
            if (((Comparable<V>) value).compareTo(me.getValue()) == 0)
                return me.getKey();
        return null;
    }
